...
namespace Exercises.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult AddMajor(Major major)
        {
            ...
            {
                ModelState.AddModelError("Major Name", "Please enter valid Major Name.");
                return View(major);
            }
            else
            {
        ...
        public ActionResult AddState(State state)
        {
            ...
            {
                ModelState.AddModelError("State Name", "Please enter valid State Name.");
                return View(state);
            }
        ...
        public ActionResult AddCourse(string courseName)
        {
            ...
            {
                ModelState.AddModelError("Course Name", "Please Enter Valid Course Name");
