...
CREATE PROCEDURE GetVehicle (@VinNumber VARCHAR(17)) AS
BEGIN
	SELECT VinNumber, ModelTypeId, BodyStyleId, InteriorColorId, ExteriorColorId, TransmissionTypeId,
		   NewOrUsedTypeId, ImageFileName, MSRP, Mileage, SalePrice, [Year], VehicleDescription, Sold, Feautured
	FROM Vehicles 
	WHERE VinNumber = @VinNumber;
END
